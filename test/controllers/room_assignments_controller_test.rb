...
class RoomAssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_assignment" do
    assert_difference("RoomAssignment.count") do
      post room_assignments_url, params: { room_assignment: { arrived_date: @room_assignment.arrived_date, checkin_date: @room_assignment.checkin_date, checkout_date: @room_assignment.checkout_date, notes: @room_assignment.notes, participant_id: @room_assignment.participant_id, room_id: @room_assignment.room_id } }
    end
  ...
  test "should update room_assignment" do
    patch room_assignment_url(@room_assignment), params: { room_assignment: { arrived_date: @room_assignment.arrived_date, checkin_date: @room_assignment.checkin_date, checkout_date: @room_assignment.checkout_date, notes: @room_assignment.notes, participant_id: @room_assignment.participant_id, room_id: @room_assignment.room_id } }
