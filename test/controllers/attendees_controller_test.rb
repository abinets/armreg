...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference("Attendee.count") do
      post attendees_url, params: { attendee: { address: @attendee.address, days_to_attend: @attendee.days_to_attend, full_name: @attendee.full_name, org: @attendee.org } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { address: @attendee.address, days_to_attend: @attendee.days_to_attend, full_name: @attendee.full_name, org: @attendee.org } }
